...
class CustomCNN(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fc = nn.Sequential(
            nn.Flatten(),
            nn.Dropout(0.01),
            nn.Linear(128 * 4 * 4, 512),  # Adjust input size based on input image dimensions
            nn.ELU(),
            nn.Dropout(0.01),
...
torch.save(vgg19.state_dict(), 'modified_vgg19_model.pth')
